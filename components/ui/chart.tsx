...
function ChartContainer({
  ...
  >["children"];
} & VariantProps<typeof aspectVariants>) {
  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        data-slot="chart"
        data-chart={chartId}
        className={cn(aspectVariants({ aspect, className }))}
        {...props}
      >
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: inject styles for charts
